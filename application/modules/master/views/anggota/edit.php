                ...
                <form action="" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" value="<?= $anggota->nomor_anggota; ?>" class="form-control" placeholder="Nomor Anggota" name="nomor_anggota">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Jurusan" name="jurusan" class="form-control" value="<?= $anggota->jurusan ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Kelas" name="kelas" class="form-control" value="<?= $anggota->kelas ?>">
                            </div>
                        </div>
                    </div>
