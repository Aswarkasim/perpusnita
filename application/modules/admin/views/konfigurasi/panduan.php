    ...
    <div class="col-md-10">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form action="<?= base_url('admin/konfigurasi/panduan') ?>" method="post">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-2">
                                <label for="" class="pull-right">Teks Panduan</label>
                            </div>
                            <div class="col-md-10">
                                <textarea name="panduan" id="editor1" cols="30" rows="10"><?= $data ?></textarea>
                            </div>
                        </div>
                    </div>
